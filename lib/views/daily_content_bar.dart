...
class _DailyContentBarState extends State<DailyContentBar> {
  ...
  Widget build(BuildContext context) {
    ...
    // Ekran boyutuna göre uygun kart genişliği
    ...
    final card = GestureDetector(
      ...
      child: Container(
        width: cardWidth,
        // Yükseklik kısıtlamasını kaldır, Expanded tarafından yönetiliyor
        child: Builder(
          builder: (context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        // Belirteç noktaları için alt boşluk: her durumda 12 piksel ekle
        // (hem klasik navigation bar hem de gesture navigation için)
        ...
        return Column(
          ...
          children: [
            if (isLandscape) 
              ...
              // Portrait modda: kullanılabilir yükseklikten indicator'lar için yer ayır
              Expanded(child: card),
