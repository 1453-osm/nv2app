...
class LocationBarState extends State<LocationBar> 
  ...
  void initState() {
    super.initState();
    // Drawer modunda animasyon controller'ı direkt genişlemiş başlat
    _animationController = AnimationController(
      duration: AnimationConstants.expansionTransition.duration,
      vsync: this,
      value: widget.isDrawerMode ? 1.0 : 0.0,
    );
  ...
  Widget _buildSelectionList(BuildContext context, LocationBarViewModel viewModel) {
    return Container(
      margin: widget.isDrawerMode ? EdgeInsets.zero : const EdgeInsets.symmetric(horizontal: 16),
  ...
  // Drawer içeriği - eski location bar içeriğini kullan
  Widget _buildDrawerContent(LocationBarViewModel viewModel) {
    ...
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        // Kapatma/Geri butonu ve Arama barı yan yana - aynı hizada
        Padding(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(
                    isSearching ? Icons.arrow_back : Symbols.location_on_rounded,
                    color: textColor,
                    size: 28,
                  ),
                ),
              ),
              // Arama barı - eski tasarım, margin kaldırıldı
              Expanded(
                child: Padding(
        ...
        // Liste - arama barı ile arasında boşluk yok
        Flexible(
          child: Padding(
