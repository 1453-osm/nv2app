...
class QiblaBarState extends State<QiblaBar> 
  ...
  void initState() {
    ...
    // Drawer modunda otomatik hesaplama yap
    if (widget.isDrawerMode && widget.location != null) {
                      ...
                      children: [
                        ...
                        if (_shouldShowExpandedContent)
                          Positioned(
                            bottom: 10,
                            left: 10,
                            right: 10, // sağda yenile butonu için boşluk bırak
                            child: IgnorePointer(
                              ignoring: !viewModel.isExpanded,
                              child: FadeTransition(
                                opacity: _fadeAnimation,
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                if ((viewModel.status == QiblaStatus.error && viewModel.errorMessage != 'GPS konumu alınamadı') || viewModel.status == QiblaStatus.needsCalibration)
                  Container(
                    padding: const EdgeInsets.all(8),
                    decoration: BoxDecoration(
                      color: textColor.withValues(alpha: 0.08),
