...
class _AnimatedBlurModal extends StatefulWidget {
  ...
  const _AnimatedBlurModal({required this.child});
    ...
    return WillPopScope(
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          return Stack(
            children: [
              // Tam ekran overlay: blur + renkli katman, sadece fade yapar (slide yapmaz)
              Positioned.fill(
                child: GestureDetector(
                  ...
                  child: BackdropFilter(
                    filter: ImageFilter.blur(
                      sigmaX: 3.0 * _blurAnimation.value,
                      sigmaY: 3.0 * _blurAnimation.value,
                    ),
                    child: Opacity(
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: ListView.separated(
                              ...
                              itemCount: widget.monthlyTimes.length,
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: items.isEmpty
                        ? Center(
                            child: Text(
                              'Bu yıl için tespit edilen dini gün bulunamadı.',
                              style: Theme.of(context).textTheme.bodyMedium?.copyWith(
...
class PrayerTimesSection extends StatelessWidget {
    ...
    return Consumer<PrayerTimesViewModel>(
      builder: (context, vm, child) {
        ...
        if (vm.errorMessage != null) {
          return _buildErrorInStack(context, vm);
        }
  ...
  Widget _buildDateCard(BuildContext context, String todayDate, String hijriDate) {
    return GestureDetector(
      behavior: HitTestBehavior.opaque,
      onTap: () => _showReligiousDaysModal(context),
      child: Padding(
  ...
  Widget _buildErrorInStack(BuildContext context, PrayerTimesViewModel vm) {
    final screenHeight = MediaQuery.of(context).size.height;
        ...
        return _AnimatedBlurModal(
          child: NotificationListener<DraggableScrollableNotification>(
            onNotification: (notification) {
              // Modal minimum boyuta ulaştığında kapatılma animasyonunu başlat
  ...
  void _showReligiousDaysModal(BuildContext context) {
    final vm = context.read<PrayerTimesViewModel>();
