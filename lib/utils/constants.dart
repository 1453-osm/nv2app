...
class GlassBarConstants {
  ...
  static const double blurSigma = 200.0;
...
class SettingsConstants {
  ...
  static const List<ThemeColorData> themeColors = [
    ThemeColorData(color: Color(0xFF588066), name: 'Ravza'),
    ThemeColorData(color: Color(0xFF1E1D1C), name: 'Harem', hasSpecialRoles: true),
    ThemeColorData(color: Color(0xFF7B8FA3), name: 'Aksa', hasSpecialRoles: true),
    ThemeColorData(color: Color(0xFF364B68), name: 'İmsak'),
    ThemeColorData(color: Color(0xFFF9C784), name: 'Güneş'),
    ThemeColorData(color: Color(0xFFDDBF50), name: 'Öğle'),
    ThemeColorData(color: Color(0xFFE2A378), name: 'İkindi'),
    ThemeColorData(color: Color(0xFF4B6587), name: 'Akşam'),
    ThemeColorData(color: Color(0xFF152240), name: 'Yatsı'),
  ];
  
  // Dinamik namaz renkleri
  static const Map<String, ThemeColorData> prayerColors = {
    'İmsak': ThemeColorData(color: Color(0xFF364B68), name: 'İmsak'),
    'Güneş': ThemeColorData(color: Color(0xFFF9C784), name: 'Güneş'),
    'Öğle': ThemeColorData(color: Color(0xFFDDBF50), name: 'Öğle'),
    'İkindi': ThemeColorData(color: Color(0xFFE2A378), name: 'İkindi'),
    'Akşam': ThemeColorData(color: Color(0xFF4B6587), name: 'Akşam'),
    'Yatsı': ThemeColorData(color: Color(0xFF152240), name: 'Yatsı'),
  };
  
  // Varsayılan tema rengi
  static const ThemeColorData defaultThemeColor = ThemeColorData(
    color: Color(0xFF588066), 
    name: 'Yeşil'
  );
  
  // Dinamik mod için varsayılan renk
  static const ThemeColorData defaultColor = ThemeColorData(
    color: Color(0xFF588066), 
    name: 'Yeşil'
  );
  ...
  static const List<SoundOptionData> soundOptions = [
    SoundOptionData(id: 'default', name: 'Varsayılan', icon: Symbols.notifications),
    SoundOptionData(id: 'adhan7', name: 'Arap Ezan', icon: Symbols.mosque),
    SoundOptionData(id: 'hard', name: 'Sert Ton', icon: Symbols.volume_up_rounded),
    SoundOptionData(id: 'soft', name: 'Yumuşak Ton', icon: Symbols.volume_down_rounded),
  ...
  @Deprecated('Use AnimationConstants.fast instead')
  static const Duration valueChangeAnimationDuration = Duration(milliseconds: 200);
}
...
class ThemeConstants {
  ...
  @Deprecated('Use ThemeService.buildTheme(brightness: Brightness.dark) instead')
