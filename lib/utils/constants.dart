...
class GlassBarConstants {
  ...
  static const double blurmSigma = 10.0;
...
class SettingsConstants {
  ...
  static const List<ThemeColorData> themeColors = [
    ThemeColorData(color: Color(0xFF588065), name: 'Ravza'),
  ...
  static const Map<String, ThemeColorData> prayerColors = {
    ...
    'Güneş': ThemeColorData(
      ...
      name: 'Güneş',
      secondaryColor: Color(0x9E5B5F67),
    ),
    'Öğle': ThemeColorData(
      color: Color(0xFF477BA6), 
      name: 'Öğle',
      secondaryColor: Color(0xFFB79A51),
    ),
    ...
    'Akşam': ThemeColorData(
      color: Color(0xFF4E6989), 
      name: 'Akşam',
      secondaryColor: Color(0xFF121838),
    ),
    'Yatsı': ThemeColorData(
      color: Color.fromARGB(255, 13, 15, 25), 
      name: 'Yatsı',
